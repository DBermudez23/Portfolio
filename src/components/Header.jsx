...
function Header() {
  return (
    <header className="w-full lg:w-140 bg-gray-800 flex flex-col items-center justify-center text-center px-4 py-6 lg:fixed lg:min-h-screen border-b-2 border-emerald-300 lg:border-r-2 lg:border-emerald-300 lg:shadow-lg">
      {/* Títles */}
